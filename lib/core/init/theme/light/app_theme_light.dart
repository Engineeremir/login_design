...
import 'abstract/ILightTheme.dart';
...
class AppThemeLight extends AppTheme with ILightTheme {
  ...
  ThemeData get theme => ThemeData(
        fontFamily: ApplicationConstants.FONT_FAMILY_OPEN_SANS,
  ...
  ColorScheme get _appColorScheme {
    return ColorScheme(
        ...
        secondaryVariant: colorSchemeLight!.primarypurple,
        surface: Colors.blue, //xx
        background: Color(0xfff6f9fc), //xx
        error: Colors.red[900]!,
        onPrimary: Colors.greenAccent,
        onSecondary: Colors.black, //x
        onSurface: Colors.purple.withOpacity(0.6),
        onBackground: colorSchemeLight!.blackGray,
